...
import { Assets, CML, LucidEvolution, Record, UTxO } from "@lucid-evolution/lucid";
...
export const retrieveLatestBlock = async (db: sqlite3.Database): Promise<[{ blockHash: string } & UTxO]> => {
