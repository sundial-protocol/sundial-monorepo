...
\subfileinclude{0-frontmatter/3-introduction}
\subfileinclude{0-frontmatter/4-toc}

\mainmatter
\subfile{1-ledger-state/0-chapter}
\subfile{1-ledger-state/1-time-model}
\subfile{1-ledger-state/2-block}
\subfile{1-ledger-state/3-confirmed-state}
\subfile{1-ledger-state/4-utxo-set}
\subfile{1-ledger-state/5-deposit-event}
\subfile{1-ledger-state/6-withdrawal-event}
\subfile{1-ledger-state/7-transaction}
...
\subfile{3-consensus-protocol/1-hub-oracle}
