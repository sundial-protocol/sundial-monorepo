...
\begin{description}
    ...
    \item[Success.] Terminate the state machine normally from the final spending validator in the computation.
      Relies on fraud proofs' last steps to couple it with the fraud proof's minting.
      Condition:
        \begin{enumerate}
            ...
            \item The transaction must burn exactly 1 computation thread token with asset name \code{successful\_computation\_thread\_token}.
        \end{enumerate}
