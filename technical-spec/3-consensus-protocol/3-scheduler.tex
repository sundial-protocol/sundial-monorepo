       ...
       \item[Rewind.] The highest-key operator advances the scheduler to the next shift and assigns it to themself, provided that no registered operators are eligible to activate.
        ...
        \begin{itemize}
            ...
            \begin{enumerate}[resume]
                ...
                \item \code{registered\_node} is \emph{not yet} eligible for activation --- the upper bound of the transaction validity interval is smaller than the sum of the \code{registration\_time} of the \code{registered\_node} and the Midgard \code{registration\_duration} protocol parameter.
            \end{enumerate}
        \end{itemize}
\end{description}
