  ...
  \item[Attach Resolution Claim.] The current operator attaches a resolution claim to a settlement node.
    Conditions:
      \begin{enumerate}
        ...
        \item The transaction must include an input, spent via the Update Bond Hold New Settlement redeemer, of an \code{active\_operators} node with a key matching the resolution claim's operator.
