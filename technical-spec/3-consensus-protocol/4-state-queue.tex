      ...
      Grouped conditions:
        \begin{itemize}
            ...
            \begin{enumerate}[resume]
                ...
                \item \code{scheduler\_state} must have an appointed operator with a PKH that matches \code{operator}.
                  Neither the transaction validity range nor the committed block interval needs to be contained within the appointed operator's nominal shift interval (see \cref{h:scheduler-utxo-representation}).
            \end{enumerate}
