...
The \code{hub\_oracle} minting policy ensures that all Midgard lists are initialized together, sent to their respective spending validator addresses, and deinitialized together. Redeemers:
\begin{description}
...
The \code{burn\_everything} validator requires every non-ADA token in the transaction to be burned. Conditions:
\begin{enumerate}
