...
The \code{escape\_hatch} minting policy initializes and deinitializes the escape hatch state. It is statically parametrized on the \code{hub\_oracle} minting policy.
Redeemers:
\begin{description}
