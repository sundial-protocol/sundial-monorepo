...
\begin{figure}[H]
\begin{center}
\includegraphics[width=\txDiagramScale\linewidth]{\subfix{../images/tx-diagram/K-init-payout.pdf}}
\end{center}
\caption[Initialize payout]{Transform a confirmed withdrawal order into a payout.}
\label{fig:tx-initialize-payout}
\end{figure}

Transform a confirmed withdrawal into a payout accumulator via a transaction that (\cref{fig:tx-initialize-payout}):
\begin{enumerate}
