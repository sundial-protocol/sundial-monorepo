...
At the time of the L1 deposit transaction, the deposit's \code{inclusion\_time} is set to the sum of the transaction's validity interval upper bound and the \code{event\_wait\_duration} Midgard protocol parameter. According to Midgard's ledger rules:
\begin{description}
