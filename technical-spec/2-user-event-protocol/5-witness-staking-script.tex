...
\begin{description}
  \item[Mint or Burn.] Script invocation to be included in the first transaction of a user event.
    Conditions:
      \begin{enumerate}
          ...
          \item Registration/unregsitration of this witness script is respectively tied to the \code{target\_policy}'s mint/burn logic. 
              \begin{itemize}
  ...
  \item[Register to Prove Not Registered.] Redeemer for proving the unregistered state of the witness script instance.
    Conditions:
      ...
      \end{enumerate}
  \item[Unegister to Prove Not Registered.] Redeemer to follow \code{RegisterToProveNotRegistered}.
    Conditions:
      \begin{enumerate}
