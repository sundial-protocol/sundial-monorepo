...
\notebox{By adjusting incentives, users can be relieved from producing the withdrawl event utxo on L1 themselves, and rely on operators to take care of this second step.}
