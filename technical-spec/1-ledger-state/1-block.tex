...
\begin{itemize}
    \item The \code{*\_root} and \code{*\_count} fields are the MPT root hashes and element counts of the corresponding sets in the block body.
    ...
    \item The \code{prev\_header\_hash} field is a hash of the previous block header.
