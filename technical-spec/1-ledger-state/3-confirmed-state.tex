...
\notebox{Settlement node optimistically resolvable by the current operator (not necessarily the original block's operator). See \cref{h:settlement-queue}}\todo
