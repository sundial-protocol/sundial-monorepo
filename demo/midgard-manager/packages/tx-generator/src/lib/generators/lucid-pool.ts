...
//
// All instances share the same zero-fee protocol parameters. Per-task wallet
// state is applied via lucid.selectWallet.fromAddress() each time a task
// acquires an instance, so distinct UTxOs are correctly isolated despite
// instance reuse.
