...
vi.mock("@/database/utils/ledger.js", async () => ({
  ...
  createTable: vi.fn(async () =>
    (await import("effect")).Effect.succeed(undefined),
  ),
  insertEntries: vi.fn(async () =>
    (await import("effect")).Effect.succeed(undefined),
  ),
  retrieveAllEntries: vi.fn(async () =>
    (await import("effect")).Effect.succeed([]),
  ),
  retrieveByOutRef: vi.fn(async () =>
    (await import("effect")).Effect.succeed(undefined),
  ),
  retrieveByOutRefs: vi.fn(async () =>
    (await import("effect")).Effect.succeed([]),
  ),
  retrieveEntriesWithAddress: vi.fn(async () =>
    (await import("effect")).Effect.succeed([]),
  ),
  delEntries: vi.fn(async () =>
    (await import("effect")).Effect.succeed(undefined),
  ),
  retrieveAllEntriesNoTimeStamps: vi.fn(async () =>
    (await import("effect")).Effect.succeed([]),
  ),
}));
vi.mock("@/database/utils/tx.js", async () => ({
  ...
  retrieveValue: vi.fn(async () =>
    (await import("effect")).Effect.succeed(undefined),
  ),
  retrieveValues: vi.fn(async () =>
    (await import("effect")).Effect.succeed([]),
  ),
  retrieveTimeBoundEntries: vi.fn(async () =>
    (await import("effect")).Effect.succeed([]),
  ),
  delMultiple: vi.fn(async () =>
    (await import("effect")).Effect.succeed(undefined),
  ),
}));
